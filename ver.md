...
- **Changes**:
  - Restored `src/renderer/icon.png` and all Android `mipmap-*` launcher icons from v1.9.42.
  - Removed `android/app/src/main/res/mipmap-anydpi-v26/ic_launcher.xml` to prevent adaptive icon clipping.
